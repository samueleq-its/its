...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:SqlDataSource ID="sdsFilm" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT * FROM [Film] ORDER BY [Titolo]"></asp:SqlDataSource>
...
<asp:GridView ID="gvFilm" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Codice" DataSourceID="sdsFilm" ForeColor="#333333" GridLines="None" HorizontalAlign="Center" PageSize="50" Width="90%">
    ...
    <Columns>
        ...
        <asp:TemplateField ShowHeader="False">
            <ItemTemplate>
                <asp:LinkButton ID="lbtDettaglio" runat="server" CausesValidation="False" Text="Dettaglio" PostBackUrl='<%# Eval("Codice","~/DettaglioFilm.aspx?codice={0}") %>'></asp:LinkButton>
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
