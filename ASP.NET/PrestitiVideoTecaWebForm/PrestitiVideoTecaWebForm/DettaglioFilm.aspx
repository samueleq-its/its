...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:SqlDataSource ID="sdsFilm" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT * FROM [Film] WHERE ([Codice] = @Codice)">
        <SelectParameters>
    ...
    <asp:DetailsView ID="dvDettaglioFilm" runat="server" AutoGenerateRows="False" CellPadding="4" DataKeyNames="Codice" DataSourceID="sdsFilm" ForeColor="#333333" GridLines="None" Height="50px" HorizontalAlign="Center" Width="60%">
