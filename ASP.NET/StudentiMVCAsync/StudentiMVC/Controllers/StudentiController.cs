...
namespace StudentiMVC.Controllers
{
    public class StudentiController : Controller
    {
        ...
        public const string STUDENTI_CSV = @"File/Studenti.csv";
        private static List<Studente> elenco;

        static StudentiController()
        {
            elenco = MyLibrary.LeggiStudenti(STUDENTI_CSV).Take(10).ToList();
        }
        ...
        public ActionResult Create(Studente studente) //IFormCollection collection
        {
            ...
            elenco.Add(studente);
            MyLibrary.ScriviStudenti(STUDENTI_CSV, elenco);
